...
def main():
    ...
    while t < 60:
        ...
        answer = t," set ", setting, signal_values[1]
        

        if t%10 == 0:
            holder = state_values[0]
            mutate_database(file_path, 0, state_values[1])
            mutate_database(file_path, 1, holder)
            answer = t," swap ", state_values[1], state_values[0]
